    ...
    <main className="min-h-screen bg-background">
        ...
        <div className="relative mx-auto grid max-w-6xl gap-10 px-5 py-16 sm:px-8 sm:py-24 lg:grid-cols-[1.05fr_.95fr] lg:items-end">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
              从移动端、Web 到服务端与系统编程的 14 条渐进式学习路线。每课只聚焦一个主题，配有最小示例、动手练习和参考答案。
            </p>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-5 py-12 sm:px-8 sm:py-16">
        <div className="mb-7 flex items-end justify-between gap-4">
          ...
          <p className="hidden text-sm text-muted-foreground sm:block">十四条路线，每个工作日各推进一课</p>
        </div>
