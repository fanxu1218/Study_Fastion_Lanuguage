...
47. [2026-09-04：WhileSubscribed停止时机测试](./2026-09-04-WhileSubscribed停止时机测试.md)——验证最后一个订阅者离开后，上游是否按设定超时停止。
48. [2026-09-07：replay缓存与重新订阅](./2026-09-07-replay缓存与重新订阅.md)——验证新订阅者能否收到最近缓存状态。
49. [2026-09-08：resetReplayCache清空事件缓存](./2026-09-08-resetReplayCache清空事件缓存.md)——在一次性事件处理后清空旧回放值。
50. [2026-09-09：subscriptionCount观察订阅者](./2026-09-09-subscriptionCount观察订阅者.md)——观察共享流当前的活跃订阅者数量。
...
59. [2026-09-22：advanceTimeBy推进部分虚拟时间](./2026-09-22-advanceTimeBy推进部分虚拟时间.md)——只推进指定虚拟时长并检查中间状态。
60. [2026-09-23：advanceTimeBy检查边界任务](./2026-09-23-advanceTimeBy检查边界任务.md)——验证虚拟时间到达边界后还需执行该时刻任务。
61. [2026-09-24：比较边界前一毫秒与到期时刻](./2026-09-24-比较边界前一毫秒与到期时刻.md)——分段推进虚拟时间检查延迟任务边界。
